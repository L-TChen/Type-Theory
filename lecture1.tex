...
\title{Lambda Calculus and Types, 1:\\<all>
...
\end{corollary}
\begin{corollary}
  \todo[inline]{introduce $\lambda$-theory}
\end{corollary}
\subsection*{Exercise}
...
\todo[inline]{introduce convention $\lambda x_1x_2\dots x_n.\;M$
stands for $\lambda x_1.\,\lambda x_2.\, \dots\lambda x_n.\,M$ etc.}
