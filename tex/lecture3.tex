...
\section{Polymorphic Typed \texorpdfstring{$\lambda$}{λ}-Calculus: Static}
...
%    \forall X.\,X \to X 
%  \]
%  Since $X$ is arbitrary, we cannot inspect the content of $X$.
%  What we can do with $X$ is simply return it.
%  \begin{theorem}
%    Every term $t$ of type $\forall X.\, X \to X$ is \emph{observationally equivalent}%
