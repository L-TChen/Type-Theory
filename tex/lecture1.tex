  ...
  \begin{align*}
    ...
    (\lambda y.\,u)\subst{t}{x} & =
                \begin{cases}
                  ...
                  \lambda z.\,((z\,y)\cdot u)\subst{t}{x} & \text{if $x \neq y$, $y \in \FV(t)$, and $z$ is fresh.}
                \end{cases}
  \end{align*}

  If the last clause is reached, then \emph{rename} the bound variable $y$ to some variable \alert{fresh} for $x$ and $t$, i.e.\ some $z$ such that $z \neq y$ and $z \notin \FV(t)$, before proceeding.
