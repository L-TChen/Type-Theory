...
\begin{frame}{What to expect next?}
  ...
  \begin{enumerate}
    \item How programs are identified \emph{up to variable renaming}?
    ...
    \item How programs are identified \emph{computationally}?
      E.g.,
      \[
...
\begin{frame}{Summary}
  \begin{center}
    ...
    \begin{tabular}{@{}ll@{}}
      ...
      $t @ u \in \Lambda(V)$
        & application of $t$ to $u$ \\

      $\lambda x.\,t \in \Lambda(V)$
        & abstraction, with $x \in V$ \\
